 ...
 */
final class Version20220526211519 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE product ADD sub_category_id INT DEFAULT NULL, CHANGE brand brand VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE product DROP sub_category_id, CHANGE brand brand INT NOT NULL');
    }
}
