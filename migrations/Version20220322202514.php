 ...
 */
final class Version20220322202514 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE order_item (id INT AUTO_INCREMENT NOT NULL, order_object_id INT NOT NULL, INDEX IDX_52EA1F099FAA2DD3 (order_object_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
