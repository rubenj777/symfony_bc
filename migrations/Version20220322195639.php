 ...
 */
final class Version20220322195639 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE order_item (id INT AUTO_INCREMENT NOT NULL, quantity INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE order_item_order (order_item_id INT NOT NULL, order_id INT NOT NULL, INDEX IDX_6C54751DE415FB15 (order_item_id), INDEX IDX_6C54751D8D9F6D38 (order_id), PRIMARY KEY(order_item_id, order_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
